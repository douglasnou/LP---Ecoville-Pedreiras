import Praca from "../../assets/praca-jucaral.png";
    ...
    return (
        <section className={styled.AboutSection}>
            <div className={styled.TextSection}>
                <h2 className={`about-title  `}>O BAIRRO PLANEJADO
                    + COMPLETO E DESEJADO
                    DA REGIÃO</h2>
                ...
                <a className={`about-btn`} href="https://wa.me/559888385253/?text=Ol%C3%A1,%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es%20sobre%20o%20Ecoville%20Pedreiras!%F0%9F%92%9A%F0%9F%A4%A9" target="blank">
                    QUERO COMPRAR
                </a>
            </div>
